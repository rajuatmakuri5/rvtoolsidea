...
with col_right:
    hcl_file = st.file_uploader(
        ...
        help="Get the latest compatibility file downloaded from https://compatibilityguide.broadcom.com/search?program=server&persona=live&column=partnerName&order=asc",
        type=["csv", "xlsx", "xls"],
    )
